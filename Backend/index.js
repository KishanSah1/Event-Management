...
// Middleware to check if the user is the owner of the event
const checkEventOwner = async (req, res, next) => {
  try {
    ...
    // Assuming the event has an 'organizedBy' field or similar
    if (event.organizedBy !== req.user.id) {
...
// Use the middleware in the delete route
app.delete('/event/:id', checkEventOwner, async (req, res) => {
  try {
