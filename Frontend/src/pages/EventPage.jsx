...
export default function EventPage() {
  ...
  if (window.confirm("Are you sure you want to delete this event?")) {
    // Assuming the token is stored in localStorage or a similar store
    ...
    axios
      ...
      .then(() => {
        ...
        navigate("/"); // Redirect to the home page or event list
      })
      .catch((error) => {
        // This is where the error handling is added
  ...
  return (
    <div className="flex flex-col mx-5 xl:mx-32 md:mx-10 mt-5 flex-grow">
      ...
      {/* Delete Button */}
      <div className="mx-2 mt-5">
        <button onClick={handleDeleteEvent} className="text-red-500 font-bold">
          Delete Event
        </button>
      </div>
